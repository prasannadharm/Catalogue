...
function getDetails() {
    $.ajax({
        ...
        url: "GramSlabMaster.aspx/GetData",
        data: {},
        dataType: "json",
...
$(function () {
    $("#btnSave").click(function () {
        ...
        $.ajax({
            type: "Post",
            contentType: "application/json; charset=utf-8",
            url: "GramSlabMaster.aspx/InsertData",
    ...
    $(document).on("click", ".deleteButton", function () {
        ...
        $.ajax({
            type: "Post",
            contentType: "application/json; charset=utf-8",
            url: "GramSlabMaster.aspx/GetUserRights",
            dataType: "json",
            success: function (data) {
                ...
                if (confirm("Are you sure you want to delete !") == true) {
                    $.ajax({
                        type: "Post",
                        contentType: "application/json; charset=utf-8",
                        url: "GramSlabMaster.aspx/DeleteData",
                        data: '{id: ' + id + '}',
                        dataType: "json",
                        success: function (data) {
                            for (var i = 0; i < data.d.length; i++) {
    ...
    $(document).on("click", ".addNewButton", function () {
        ...
        $("div.modal-header h2").html("Add Gram Slab Details");
        $('#NAME1').focus();
    });
    ...
    $(document).on("click", ".editButton", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#PopupModal').focus();
                $("#NAME1").val("");
                $("div.modal-header h2").html("Edit Gram Slab Details");

                $.ajax({
                    type: "Post",
                    contentType: "application/json; charset=utf-8",
                    url: "GramSlabMaster.aspx/EditData",
                    data: '{id: ' + id + '}',
                    dataType: "json",
                    success: function (data) {
                        for (var i = 0; i < data.d.length; i++) {
    ...
    $("#btnUpdate").click(function () {
        ...
        $.ajax({
            type: "Post",
            contentType: "application/json; charset=utf-8",
            url: "GramSlabMaster.aspx/UpdateData",
