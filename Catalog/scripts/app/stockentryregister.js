...
function generatereport() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            shtml = shtml + "<thead>";
            shtml = shtml + "<tr><th style='border: 1px solid black;'>Trans No</th><th style='border: 1px solid black;'>Trans Date</th><th style='border: 1px solid black;'>Ref No</th><th style='border: 1px solid black;'>Ledger</th><th style='border: 1px solid black;'>Remarks</th><th style='border: 1px solid black;'>Void</th><th style='border: 1px solid black;'>Created By</th><th style='border: 1px solid black;'>Modified By</th></tr>";
            shtml = shtml + "</thead>";
            shtml = shtml + "<tbody>";
            for (var i = 0; i < data.d.length; i++) {
