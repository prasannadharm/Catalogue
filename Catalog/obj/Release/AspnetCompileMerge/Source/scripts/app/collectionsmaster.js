...
function getDetails() {
    $.ajax({
        ...
        url: "CollectionsMaster.aspx/GetData",
        data: {},
        dataType: "json",
...
$(function () {
    $("#btnSave").click(function () {
        ...
        $.ajax({
            type: "Post",
            contentType: "application/json; charset=utf-8",
            url: "CollectionsMaster.aspx/InsertData",
    ...
    $(document).on("click", ".deleteButton", function () {
        ...
        $.ajax({
            type: "Post",
            contentType: "application/json; charset=utf-8",
            url: "CollectionsMaster.aspx/GetUserRights",
            dataType: "json",
            success: function (data) {
                ...
                if (confirm("Are you sure you want to delete !") == true) {
                    $.ajax({
                        type: "Post",
                        contentType: "application/json; charset=utf-8",
                        url: "CollectionsMaster.aspx/DeleteData",
                        data: '{id: ' + id + '}',
                        dataType: "json",
                        success: function (data) {
                            for (var i = 0; i < data.d.length; i++) {
    ...
    $(document).on("click", ".addNewButton", function () {
        ...
        $("div.modal-header h2").html("Add Collections Details");
        $('#NAME1').focus();
    });
    ...
    $(document).on("click", ".editButton", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#PopupModal').focus();
                $("#NAME1").val("");
                $("div.modal-header h2").html("Edit Collections Details");

                $.ajax({
                    type: "Post",
                    contentType: "application/json; charset=utf-8",
                    url: "CollectionsMaster.aspx/EditData",
                    data: '{id: ' + id + '}',
                    dataType: "json",
                    success: function (data) {
                        for (var i = 0; i < data.d.length; i++) {
    ...
    $("#btnUpdate").click(function () {
        ...
        $.ajax({
            type: "Post",
            contentType: "application/json; charset=utf-8",
            url: "CollectionsMaster.aspx/UpdateData",
