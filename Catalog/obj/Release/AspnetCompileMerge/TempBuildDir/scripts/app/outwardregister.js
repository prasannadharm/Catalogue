$(document).ready(function () {
    ...
    $.ajax({
        url: "OutwardRegister.aspx/GetCurrentDate",
        data: '{}',
        dataType: "json",
        type: "POST",
...
function generatereport() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            shtml = shtml + "<thead>";
            shtml = shtml + "<tr><th style='border: 1px solid black;'>Trans No</th><th style='border: 1px solid black;'>Trans Date</th><th style='border: 1px solid black;'>Ref No</th><th style='border: 1px solid black;'>Ledger</th><th style='border: 1px solid black;'>Outward Type</th><th style='border: 1px solid black;'>Remarks</th><th style='border: 1px solid black;'>Void</th><th style='border: 1px solid black;'>Created By</th><th style='border: 1px solid black;'>Modified By</th></tr>";
            shtml = shtml + "</thead>";
            shtml = shtml + "<tbody>";
            for (var i = 0; i < data.d.length; i++) {
                if (mainid != data.d[i].TRANS_MAIN_ID) {
                    ...
                    shtml = shtml + "<td style='text-align:center;border: 1px solid black;'>" + data.d[i].OUT_TYPE_NAME + "</td>";
                    shtml = shtml + "<td style='border: 1px solid black;border: 1px solid black;'>" + data.d[i].REMARKS_M + "</td>";
