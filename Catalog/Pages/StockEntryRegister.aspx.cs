...
namespace Catalog.Pages
{
    public partial class StockEntryRegister : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static StockEntryRegisterResultEntity[] GetStockEntryRegisterData(StockEntryRegisterParamEntity obj)
        {
            List<StockEntryRegisterResultEntity> details = new List<StockEntryRegisterResultEntity>();
            try
            {
                details = new StockEntryDAO().GetStockEntryRegister(obj);
            }
            catch (Exception ex)
            {
                // details.Add(new DbStatusEntity(ex.Message));
