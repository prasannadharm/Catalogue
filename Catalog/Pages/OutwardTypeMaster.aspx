<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/CatalogAdmin.Master" AutoEventWireup="true" CodeBehind="OutwardTypeMaster.aspx.cs" Inherits="Catalog.Pages.OutwardTypeMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="../scripts/app/outwardtypemaster.js"></script>
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="row">
                <div class="col-6">
                    <h2>Outward Type Master</h2>
                </div>
                <div class="col-6">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>Edit Outward Type Details</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="panel-body">
                        <div class="form-group col-lg-12">
                            <label>Outward Type Name</label>
                            <input type="text" name="NAME" id="NAME1" class="form-control" placeholder="Please enter Name" />
                        </div>
                        <div class="form-group col-lg-12">
                            <label>Returnable</label>
                            <input type="checkbox" name="RETURNABLE" id="RETURNABLE1" style="margin-left: 10px; vertical-align: middle;" />
                        </div>
                        <div class="form-group col-lg-12">
