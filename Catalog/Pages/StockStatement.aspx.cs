...
namespace Catalog.Pages
{
    public partial class StockStatement : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static StockStatementResultEntity[] GetStockStatementData(StockStatementParamEntity obj)
        {
            List<StockStatementResultEntity> details = new List<StockStatementResultEntity>();
            try
            {
                details = new StockStatementDAO().GetStockStatementData(obj);
            }
            catch (Exception ex)
            {
