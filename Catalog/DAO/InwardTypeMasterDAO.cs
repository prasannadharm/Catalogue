...
{
    public class InwardTypeMasterDAO
    {
        public List<InwardTypeMasterEntity> GetInwardTypeMasterList()
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("USP_GetInwardTypeMasterList", con);
        ...
        public List<InwardTypeMasterEntity> EditInwardType(int id)
        {
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            SqlDataAdapter adapter;
            DataSet ds = new DataSet();
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_GetInwardTypeDetailsbyID", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DbStatusEntity UpdateInwardType(InwardTypeMasterEntity obj, int id)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_UpdateInwardTypeMaster", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id);
        ...
        public DbStatusEntity InsertInwardTypeMaster(InwardTypeMasterEntity obj)
        {
            DbStatusEntity objreturn = new DbStatusEntity();
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_InsertInwardTypeMaster", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@NAME", obj.NAME);
                    cmd.Parameters.AddWithValue("@ACTIVE_STATUS", obj.ACTIVE_STATUS);
        ...
        public DbStatusEntity DeleteInwardType(int id)
        {
            DbStatusEntity objreturn = new DbStatusEntity();
            string CS = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
            try
            {
                using (SqlConnection con = new SqlConnection(CS))
                {
                    SqlCommand cmd = new SqlCommand("USP_DeleteInwardTypeMaster", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id);
